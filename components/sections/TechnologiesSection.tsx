...
const technologies = [
  {
    ...
    color: '#61DAFB',
    logo: (
      <svg className="w-8 h-8 text-[#61DAFB] animate-[spin_20s_linear_infinite]" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    color: '#96BF48',
    logo: (
      <svg className="w-8 h-8 text-[#96BF48]" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    ...
    color: '#0055FF',
    logo: (
      <svg className="w-8 h-8 text-[#0055FF]" viewBox="0 0 24 24" fill="currentColor">
        <path d="M5 2h14v6.5l-7 7.5 7 7.5V22H5v-6.5l7-7.5-7-7.5z"/>
      </svg>
    )
  },
  {
    ...
    logo: (
      <svg className="w-8 h-8 text-[#FFCA28]" viewBox="0 0 24 24" fill="currentColor">
        <path d="M3.89 15.75L1.15 10.5c-.35-.67-.13-1.49.52-1.9l8.63-5.27c.45-.27.99-.27 1.44 0l8.63 5.27c.65.41.87 1.23.52 1.9l-2.74 5.25c-.29.56-.87.91-1.5.91H5.39c-.63 0-1.21-.35-1.5-.91z"/>
        <path d="M12 2.5l7.9 4.8-1.5 2.9-6.4-3.9v-3.8zm0 0l-7.9 4.8 1.5 2.9 6.4-3.9v-3.8z" opacity="0.6"/>
      </svg>
    )
  },
  {
  ...
  },
  {
    ...
    logo: (
      <svg className="w-8 h-8 text-[#336791]" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z"/>
        <path d="M16 11c0-2.21-1.79-4-4-4s-4 1.79-4 4 1.79 4 4 4 4-1.79 4-4z" opacity="0.6"/>
      </svg>
    )
  },
  {
    ...
    color: '#F24E1E',
    logo: (
      <svg className="w-8 h-8 text-[#F24E1E]" viewBox="0 0 24 24" fill="currentColor">
        <path d="M8 2h4v8H8zm0 8h4v4H8zm0 4a4 4 0 110-8h4v8zm8-6a4 4 0 11-4 4h4z" />
      </svg>
    )
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4">
          {technologies.map((tech, i) => (
            ...
            >
              <div
                className="w-16 h-16 rounded-xl flex items-center justify-center border border-gray-100 group-hover:scale-110 transition-transform shadow-sm"
                style={{ background: `${tech.color}08` }}
              >
                {tech.logo}
              </div>
              <p className="text-text-secondary text-xs font-semibold text-center group-hover:text-text-primary transition">
                {tech.name}
              </p>
            </motion.div>
          ))}
